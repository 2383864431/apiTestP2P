...
class test_tender_process(unittest.TestCase):
    ...
    def tearDownClass(cls) -> None:
        cls.session.close()
        sql1 = "delete from mb_member_register_log where phone in ('13033447711','13033447715','13033447713','13033447714','13033447712');"
        DButils.delete(app.DB_MEMBER,sql1)
        logging.info("delete sql={}".format(sql1))
        sql2 = "delete i.* from mb_member_login_log i INNER JOIN mb_member m on i.member_id = m.id WHERE m.phone in ('13033447711','13033447715','13033447713','13033447714','13033447712');"
        DButils.delete(app.DB_MEMBER, sql2)
        logging.info("delete sql={}".format(sql2))
        sql3 = "delete i.* from mb_member_info i INNER JOIN mb_member m on i.member_id = m.id WHERE m.phone in ('13033447711','13033447715','13033447713','13033447714','13033447712');"
        DButils.delete(app.DB_MEMBER, sql3)
        logging.info("delete sql={}".format(sql3))
        sql4 = "delete from mb_member WHERE phone in ('13033447711','13033447715','13033447713','13033447714','13033447712');"
